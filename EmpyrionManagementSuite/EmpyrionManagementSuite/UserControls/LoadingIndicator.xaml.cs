...
namespace EmpyrionManagementSuite.UserControls
{
    ...
    public partial class LoadingIndicator : UserControl
    {
        public static readonly DependencyProperty MinimumProperty =
                   DependencyProperty.Register("Minimum", typeof(int), typeof(LoadingIndicator), new UIPropertyMetadata(1));

        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(int), typeof(LoadingIndicator), new UIPropertyMetadata(1));

        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(int), typeof(LoadingIndicator), new UIPropertyMetadata(100));

        private readonly DispatcherTimer _animationTimer;

        /// <summary>
        /// Initializes a new instance of the <see
        /// cref="CircularProgressBar" /> class.
        /// </summary>
