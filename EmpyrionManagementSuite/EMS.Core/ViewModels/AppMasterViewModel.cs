...
namespace EMS.Core.ViewModels
{
    public class AppMasterViewModel : ViewModelCommon
    {
        ...
        private void CloseApplication()
        {
            try
            {
                if (MessageBox.Show(ResourceManager.GetResource("APP_CONFIRM_SHUTDOWN"), ResourceManager.GetResource("APP_QUIT"), MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
                {
